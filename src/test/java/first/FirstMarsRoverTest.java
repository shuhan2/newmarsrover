...
class FirstMarsRoverTest {
  ...
  @Test
  void should_return_north_x_1_y_0_when_back_and_move_forward_given_north_x_1_y_1() {
    FirstMarsRover marsRover = new FirstMarsRover(1, 1, NORTH);
  ...
  @Test
  void should_return_south_x_1_y_2_when_back_and_move_forward_given_south_x_1_y_1() {
    FirstMarsRover marsRover = new FirstMarsRover(1, 1, SOUTH);
  ...
  @Test
  void should_return_south_x_2_y_1_when_back_and_move_forward_given_west_x_1_y_1() {
    FirstMarsRover marsRover = new FirstMarsRover(1, 1, WEST);
  ...
  @Test
  void should_return_north_x_1_y_2_when_back_and_h_and_move_forward_given_north_x_1_y_1() {
    FirstMarsRover marsRover = new FirstMarsRover(1, 1, NORTH);

    marsRover.executeCommand(B);
    marsRover.executeCommand(H);
    marsRover.executeCommand(M);
  ...
  @Test
  void should_return_south_x_1_y_0_when_back_and_h_and_move_forward_given_south_x_1_y_1() {
    FirstMarsRover marsRover = new FirstMarsRover(1, 1, SOUTH);
  ...
  @Test
  void should_return_west_x_0_y_1_when_back_and_h_and_move_forward_given_west_x_1_y_1() {
    FirstMarsRover marsRover = new FirstMarsRover(1, 1, WEST);
  ...
  @Test
  void should_return_east_x_2_y_1_when_back_and_h_and_move_forward_given_east_x_1_y_1() {
    FirstMarsRover marsRover = new FirstMarsRover(1, 1, EAST);
